...
public class Board {
    ...
    private static final String[] WORDS = {
        ...
        "oil", "sunflower", "olive", "star", "castle", "spider", "cactus", "knight",
        "plum", "carrot", "panda", "banana", "jungle", "shell", "diamond", "tablet",
        "window", "cloud", "mountain", "bubble", "umbrella", "pillow", "sandal", "bicycle",
        "lighthouse", "television", "basket", "dragon", "robot", "glove", "piano", "brush",
        "squirrel", "peach", "socks", "scarf", "oyster", "flute", "trophy", "kite", 
        "mango", "carpet", "forest", "candle", "puzzle", "wallet", "tshirt", "blanket",
        "lobster", "guitar", "ladder", "horizon", "keyboard", "microwave",
        "zebra", "cavern", "cupcake", "telescope", "icicle", "dolphin", "goblin", 
        "spaghetti", "vacation", "plaid", "goblet", "trumpet", "trolley",
        ...
        "yarn", "sundial", "thimble", "nail", "dawn", "river", "mushroom", "spade", 
        "sailor", "turbine", "knot", "pebble", "talon", "styrofoam", "plaque", 
        "panel", "pepper", "crash", "butter", "turtle", "jet", "crane", "thermal", "grape", 
        "hive", "vortex", "weasel", "marble", "balloon", "crystal", "turf", "whistle",
