...
public class GameConfiguration {
    ...
    public void addPlayer(Player newPlayer) throws IllegalStateException, NullPointerException, IllegalStateException {
        if (newPlayer == null) {throw new NullPointerException("Class GameConfiguration; addPlayer: Null was provided as Parameter");}
        ...
        throw new IllegalStateException("Class GameConfiguration; addPlayer: The Maximum number of Players is already reached");
    }

    public void setPlayerRole(String playerName, PlayerRoles role) throws NoSuchElementException, NullPointerException {
        if (playerName == null) {throw new NullPointerException("Class GameConfiguration; setPlayerRole: Null was provided as Parameter Playername");}
        else if (role == null) {throw new NullPointerException("Class GameConfiguration; setPlayerRole: Null was provided as Parameter Role");}
        else if (this.getNamebyRole(role).isPresent()) {
            throw new IllegalStateException("Class GameConfiguration; setPlayerRole: The desired role is already occupied");
        }
